...
@section('content')
    ...
    <body>
        <div class="container mt-3">
            <form class="row g-3" action="{{ url('/employees/createAction') }}" method="post">
                @csrf
                <div class="col-md-4">
                ...
                <div class="col-4">
                    ...
                    <input type="text" name="cargo" class="form-control" id="input-cargo" required>
                </div>

                <div class="col-12">
                    <button type="submit" value="Submit" class="btn btn-warning">Cadastrar Funcionário</button>
                </div>
            </form>
        </div>
    </body>
